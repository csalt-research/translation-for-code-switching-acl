MONO_DATASET='en:./data/PRETRAIN_COMBINED/en.train.tok.pth,,;hi:./data/PRETRAIN_COMBINED/hi.train.tok.pth,,'
PARA_DATASET='en-hi:./data/PRETRAIN_COMBINED/XX.train.tok.pth,./data/PRETRAIN_COMBINED/XX.valid.tok.pth,./data/PRETRAIN_COMBINED/XX.test.tok.pth'
