...
def get_parser():
	...
	parser.add_argument("--exp_name", type=str, default="IITB-Parallel",
	...
	parser.add_argument("--share_enc", type=int, default=2,
						help="Number of layers to share in the encoders")
	parser.add_argument("--share_dec", type=int, default=2,
	...
	parser.add_argument("--enc_optimizer", type=str, default="adam,lr=0.0001",
	...
	parser.add_argument("--stopping_criterion", type=str, default="bleu_en_hi_valid,10",
	...
	parser.add_argument("--pretrained_out", type=bool_flag, default=True,
...
def main(params):
	...
	evaluator.custom_discriminator_step('valid')
# 	total_loss = 0
# 	for step in range(1000000):
# 		loss = trainer.custom_discriminator_step()
# 		total_loss += loss
# 		if (step + 1) % 1000 == 0:
# 			evaluator.custom_discriminator_step()
# 			print (step + 1, total_loss)
# 			total_loss = 0
