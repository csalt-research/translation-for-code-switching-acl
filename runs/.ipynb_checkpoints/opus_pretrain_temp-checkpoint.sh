MONO_DATASET='en:./data/OPUS/en.train.tok.pth,,;hi:./data/OPUS/hi.train.tok.pth,,'
PARA_DATASET='en-hi:./data/OPUS/XX.train.tok.pth,./data/OPUS/XX.valid.tok.pth,./data/OPUS/XX.test.tok.pth'
PRETRAINED='./data/all.256.vec'

CUDA_VISIBLE_DEVICES=1 python3 main.py \
--exp_name opus_pretrain_temp \
--transformer True \
--n_enc_layers 3 \
--n_dec_layers 3 \
--share_enc 2 \
