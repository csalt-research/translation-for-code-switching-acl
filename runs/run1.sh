MONO_DATASET='en:./data/treebankmono/en.train.pth,,;hi:./data/treebankmono/hi.train.pth,,'
PARA_DATASET='en-hi:,./data/treebankmono/XX.valid.pth,./data/treebankmono/XX.test.pth'
PRETRAINED='./data/all.256.vec'

CUDA_VISIBLE_DEVICES=0 python3 main.py \
--exp_name treebankmono \
--transformer True \
--n_enc_layers 3 \
--n_dec_layers 3 \
--share_enc 2 \
...
--reload_model finaldump/treebankmono/best-bleu_en_hi_en_valid.pth \
--reload_enc True \
--reload_dec True \
--eval_only True 
