MONO_DATASET='en:./data/OPUS-EMT/en.train.tok.pth,,;hi:./data/OPUS-EMT/hi.train.tok.pth,,'
PARA_DATASET='en-hi:,./data/OPUS-EMT/XX.valid.tok.pth,./data/OPUS-EMT/XX.test.tok.pth'
PRETRAINED='./data/all.256.vec'

CUDA_VISIBLE_DEVICES=0 python3 main.py \
--exp_name emt_transfer \
--transformer True \
--n_enc_layers 3 \
--n_dec_layers 3 \
--share_enc 2 \
