...
DATA_PATH=$PWD/common

MONO_PATH1=$DATA_PATH/OPUS-100
MONO_PATH2=$DATA_PATH/IITB
MONO_PATH3=$DATA_PATH/combinedcs
MONO_PATH4=$DATA_PATH/PRETRAIN_COMBINED
# MONO_PATH5=$DATA_PATH/OPUS-LEX
# MONO_PATH6=$DATA_PATH/OPUS-EMT
# MONO_PATH7=$DATA_PATH/OPUS-100-LEX
...
# files full paths
SRC_RAW1=$MONO_PATH1/opus.en-hi-valid.hi.filtered
SRC_RAW2=$MONO_PATH1/opus.en-hi-train.hi.filtered
SRC_RAW3=$MONO_PATH1/opus.en-hi-test.hi.filtered

TGT_RAW1=$MONO_PATH1/opus.en-hi-valid.en.filtered
TGT_RAW2=$MONO_PATH1/opus.en-hi-train.en.filtered
TGT_RAW3=$MONO_PATH1/opus.en-hi-test.en.filtered

SRC_RAW4=$MONO_PATH2/IITB.hi.train
SRC_RAW5=$MONO_PATH2/IITB.hi.test
SRC_RAW6=$MONO_PATH2/IITB.hi.valid

TGT_RAW4=$MONO_PATH2/IITB.en.train
TGT_RAW5=$MONO_PATH2/IITB.en.test
TGT_RAW6=$MONO_PATH2/IITB.en.valid

SRC_RAW7=$MONO_PATH3/combinedcs.hi.train
SRC_RAW8=$MONO_PATH3/combinedcs.hi.test
SRC_RAW9=$MONO_PATH3/combinedcs.hi.valid

TGT_RAW7=$MONO_PATH3/combinedcs.en.train
TGT_RAW8=$MONO_PATH3/combinedcs.en.test
TGT_RAW9=$MONO_PATH3/combinedcs.en.valid

SRC_RAW10=$MONO_PATH4/hi.train
SRC_RAW11=$MONO_PATH4/hi.test
SRC_RAW12=$MONO_PATH4/hi.valid

TGT_RAW10=$MONO_PATH4/en.train
TGT_RAW11=$MONO_PATH4/en.test
TGT_RAW12=$MONO_PATH4/en.valid
...
# SRC_RAW19=$MONO_PATH7/hi.train
# SRC_RAW20=$MONO_PATH7/hi.test
# SRC_RAW21=$MONO_PATH7/hi.valid

# TGT_RAW19=$MONO_PATH7/en.train
# TGT_RAW20=$MONO_PATH7/en.test
# TGT_RAW21=$MONO_PATH7/en.valid
...
# echo "Extracting vocabulary..."
# cat $SRC_RAW2 $SRC_RAW4 $SRC_RAW7 | $FASTBPE getvocab - >$SRC_VOCAB
# cat $TGT_RAW2 $TGT_RAW4 $TGT_RAW7 | $FASTBPE getvocab - >$TGT_VOCAB
# cat $SRC_RAW2 $TGT_RAW2 $SRC_RAW4 $TGT_RAW4 $SRC_RAW7 $TGT_RAW7 | $FASTBPE getvocab - >$FULL_VOCAB
...
# cat $SRC_RAW1 $SRC_RAW2 $SRC_RAW3 $SRC_RAW4 $SRC_RAW5 $SRC_RAW6 $SRC_RAW7 $SRC_RAW8 $SRC_RAW9 $TGT_RAW1 $TGT_RAW2 $TGT_RAW3 $TGT_RAW4 $TGT_RAW5 $TGT_RAW6 $TGT_RAW7 $TGT_RAW8 $TGT_RAW9 | shuf > $CONCAT_BPE
# # fi
